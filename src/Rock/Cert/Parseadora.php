...
class Rock_Cert_Parseadora
{
    ...
    public function getCertificado()
    {
        ...
        $dadosRock_Certificado = openssl_x509_parse($certificado, false);
        $razaoSocial = '';
        $cpfCnpj = '';
        ...
        // http://www.receita.fazenda.gov.br/acsrf/LeiautedeRock_CertificadosdaSRF.pdf
        if (array_key_exists('commonName', $dadosRock_Certificado['subject'])) {
            list ($razaoSocial, $cpfCnpj) = explode(':', $dadosRock_Certificado['subject']['commonName']);
        } elseif (array_key_exists('CN', $dadosRock_Certificado['subject'])) {
            list ($razaoSocial, $cpfCnpj) = explode(':', $dadosRock_Certificado['subject']['CN']);
        }
